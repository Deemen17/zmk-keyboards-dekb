...
void de_indicator_init_thread(void) {
    ...
    indicator_state.keylock = 0;
    indicator_state.battery = 111;

    // LOG_INF("Indicator self-test start");
    // set_indicator_color(0b001); // red
    // k_msleep(150);
    // set_indicator_color(0b010); // green
    // k_msleep(150);
    // set_indicator_color(0b100); // blue
    // k_msleep(150);
    // set_indicator_color(0);
    // LOG_INF("Indicator self-test done");
}
K_THREAD_DEFINE(de_indicator_init_tid, 1024, de_indicator_init_thread, NULL, NULL, NULL,
